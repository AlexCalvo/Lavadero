...
public class InformePorVecesFechas {
	...
	public static void main(String[] args, LocalDate fecInicio, LocalDate fecFin, int numVeces) throws Exception {
		String outputFileName = "PorVecesFechas.pdf";
		if (args.length > 0)
			outputFileName = args[0];

		List<Lavados> listaLavados = Models.Lavados.listaLavadosPorVecesFechas(fecInicio, fecFin, numVeces);
		...
		Cell<PDPage> cell = headerRow.createCell(100,
				"Lista lavados - " + numVeces + " veces - Entre " + fecInicio + " y " + fecFin);
