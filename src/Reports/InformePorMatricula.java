...
public class InformePorMatricula {
	public static void main (String[] args) throws Exception {
		String outputFileName = "InformeMatricula.pdf";
		if (args.length > 0)
			outputFileName = args[0];
		generateInforme(outputFileName, "122");
	}

	public static void generateInforme(String outFile, String matricula) throws Exception {
		...
		Cell<PDPage> cell = headerRow.createCell(100, "Lista lavados de coche: " + matricula);
