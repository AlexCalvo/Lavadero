...
public class InformeEntreFechas {
	...
	public static void main(String[] args, LocalDate fecInicio, LocalDate fecFin) throws Exception {
		String outputFileName = "EntreFechas.pdf";
		if (args.length > 0)
			outputFileName = args[0];

		List<Lavados> listaLavados = Models.Lavados.listaLavadosPorFechas(fecInicio, fecFin);
