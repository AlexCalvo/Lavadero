...
public class InformeLavadosPorMatricula {

	public static void main(String[] args, String matricula) throws Exception {
		String outputFileName = "PorMatricula.pdf";
		if (args.length > 0)
			outputFileName = args[0];

		List<Lavados> listaLavados = Models.Lavados.listaLavadosPorMatricula(matricula);
		...
		Cell<PDPage> cell = headerRow.createCell(100, "Lista lavados - Matricula " + matricula);
		...
		// cell = row.createCell(30, "long text long text long text long text long text
		// long text long text");
		// cell.setFontSize(12);
