...
public class InformePorPropietario{
	public static void main (String[] args) throws Exception {
		String outputFileName = "InformePropietario.pdf";
		if (args.length > 0)
			outputFileName = args[0];
		generateInforme(outputFileName, "a");
	}

	public static void generateInforme(String outFile, String propietario) throws Exception {

		List<Lavados> listaLavados = Models.Lavados.listaLavadosPorPropietario(propietario);
		...
		Cell<PDPage> cell = headerRow.createCell(100, "Lista lavados por propietario: "+ propietario);
