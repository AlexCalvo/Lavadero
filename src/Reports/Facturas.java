...
public class Facturas {
	public static void main (String[] args) throws Exception {
		String outputFileName = "Facturas.pdf";
		if (args.length > 0)
	...
	public static void generateInforme(String outFile,LocalDate fecIni,LocalDate fecFin) throws Exception {
		...
		List<Lavados> listaLavados = Models.Lavados.listaFacturas(fecIni, fecFin);
		...
		Cell<PDPage> cell = headerRow.createCell(100, "Lista facturas entre "+fecIni+ " y " +fecFin);
