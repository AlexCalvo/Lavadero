...
public class CtrLavados implements ActionListener, ListSelectionListener, DateChangeListener {
	...
	private void ventana() {
		...
		try {
			...
			double pE = Double.parseDouble(JOptionPane.showInputDialog("Inserte precio de lavado exterior"));
			double pI = Double.parseDouble(JOptionPane.showInputDialog("Inserte precio de lavado interior"));
			double pC = Double.parseDouble(JOptionPane.showInputDialog("Inserte precio de lavado completo"));
			
			Modelo newModelo = new Modelo(view.getStringModelo(), pE, pI, pC);
